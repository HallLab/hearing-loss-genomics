...
#
# Outputs: analysis/elena/outputs/phase1/
# Log:     analysis/elena/logs/phase1/run_<timestamp>.log
#
...
OUT_DIR="analysis/elena/outputs/phase1"
LOG_DIR="analysis/elena/logs/phase1"
